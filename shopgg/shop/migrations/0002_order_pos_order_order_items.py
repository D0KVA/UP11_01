    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_addresses', models.CharField(max_length=255, verbose_name='Адрес доставки')),
                ('delivery_type', models.CharField(choices=[('EzkhereShop', 'Вывоз из магазина'), ('KrutoiChel', 'Курьер'), ('PP', 'Пункт выдачи заказов')], default='EzkhereShop', max_length=15, verbose_name='Способ доставки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='shop.items', verbose_name='Товар')),
        ...
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ManyToManyField(through='shop.Pos_order', to='shop.items', verbose_name='Товар'),
        ),
    ]
